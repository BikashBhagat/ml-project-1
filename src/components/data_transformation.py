'''
input will be data ingestin output
out put should be trnasform data
...
class DataTransformation:
    ...
    def get_transformer_obj(self):
       ...
       'test_preparation_course']
            ...
            logging.info("Feature Selected as per numeric and categorical")
            ...
            logging.info(f"Numerical Feature Imputed and Standardize: {num_features}")
            ...
            logging.info(f"Categorical Feature Imputed and Encoded: {cat_features}")
    ...
    def initiate_data_transformation(self,train_path, test_path):
        ...
        try:
            ...
            logging.info("Read Train and Test dta set")
            ...
            logging.info("Applying Tranformation on train and test dataset.")
